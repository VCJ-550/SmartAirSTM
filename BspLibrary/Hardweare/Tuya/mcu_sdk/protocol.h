...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "eacdmmwmpbhsyawp"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//二氧化碳浓度(只上报)
//备注:
#define DPID_CO2_VALUE 101
//光照强度(只上报)
//备注:
#define DPID_LIGHT_VALUE 102
//甲醛浓度(只上报)
//备注:
#define DPID_CH4O_VALUE 103
//PM1浓度(只上报)
//备注:
#define DPID_PM1_VALUE 104
//PM2.5浓度(只上报)
//备注:
#define DPID_PM2_5_VALUE 105
//PM10浓度(只上报)
//备注:
#define DPID_PM10_VALUE 106
//噪声等级(只上报)
//备注:
#define DPID_NOISE_VALUE 107
